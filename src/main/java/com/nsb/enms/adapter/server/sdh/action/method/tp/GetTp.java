			...
			while ((line = br.readLine()) != null) {
				if (line.contains("GetReply received")) {
					...
					while ((line = br.readLine()) != null) {
						...
						/*
						 * if (line.startsWith("alarmStatus")) { String
						 * alarmStatus = ParseUtil.parseAttr( line ); String[]
						 * elements = alarmStatus.split( "_" );
						 * portEntity.setAlarmStatus( elements[0] ); if(
						 * elements.length == 2 ) { portEntity.setAlarmStatus(
						 * elements[1] ); } continue; }
						 */
