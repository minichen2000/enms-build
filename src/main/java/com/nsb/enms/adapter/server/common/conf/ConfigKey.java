...
public class ConfigKey
{
    ...
    public static final String DEFAULT_GET_EQ_REQ = DEFAULT_TSTMGR_SCENARIO_DIR
            + "syncEquipment.req";

    public static final String GET_NE_REQ = "GET_NE_REQ";

    public static final String DEFAULT_GET_NE_REQ = DEFAULT_TSTMGR_SCENARIO_DIR
            + "ListNe.req";
    ...
    public static final String DEFAULT_CREATE_XC_VC4_REQ = DEFAULT_TSTMGR_SCENARIO_DIR
            + "createXC-VC4-withMatrix.req";
    ...
    public static final String DEFAULT_DELETE_XC_REQ = DEFAULT_TSTMGR_SCENARIO_DIR
            + "deleteXC.req";

    public static final String GET_PORT_REQ = "GET_PORT_REQ";

    public static final String DEFAULT_GET_PORT_REQ = DEFAULT_TSTMGR_SCENARIO_DIR
            + "syncPort.req";

    public static final String GET_CONNECTION_PORT_REQ = "GET_CONNECTION_PORT_REQ";

    public static final String DEFAULT_GET_CONNECTION_PORT_REQ = DEFAULT_TSTMGR_SCENARIO_DIR
            + "syncCTP.req";

    public static final String CREATE_NE_REQ = "CREATE_NE_REQ";

    public static final String DEFAULT_CREATE_NE_REQ = DEFAULT_TSTMGR_SCENARIO_DIR
            + "CreateNe.req";
    ...
    public static final String DEFAULT_DELETE_NE_REQ = DEFAULT_TSTMGR_SCENARIO_DIR
            + "RemoveNe.req";
