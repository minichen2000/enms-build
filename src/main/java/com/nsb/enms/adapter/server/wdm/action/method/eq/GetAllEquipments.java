...
import com.nsb.enms.mib.pss.def.TnCardManufacturingPartNumber;
import com.nsb.enms.mib.pss.def.TnCardName;
import com.nsb.enms.mib.pss.def.TnCardSWPartNum;
import com.nsb.enms.mib.pss.def.TnCardSerialNumber;
import com.nsb.enms.mib.pss.def.TnShelfName;
import com.nsb.enms.mib.pss.def.TnShelfPresentType;
import com.nsb.enms.mib.pss.def.TnShelfProgrammedType;
import com.nsb.enms.mib.pss.def.TnShelfRiManufacturingPartNumber;
import com.nsb.enms.mib.pss.def.TnShelfRiSWPartNum;
import com.nsb.enms.mib.pss.def.TnShelfRiSerialNumber;
import com.nsb.enms.mib.pss.def.TnSlotPresentType;
import com.nsb.enms.mib.pss.def.TnSlotProgrammedType;
...
public class GetAllEquipments
{
            ...
            throws AdapterException
    {
        ...
        leafOids.add( TnShelfName.oid );
        leafOids.add( TnShelfProgrammedType.oid );
        leafOids.add( TnShelfPresentType.oid );

        leafOids.add( TnShelfRiManufacturingPartNumber.oid );
        leafOids.add( TnShelfRiSWPartNum.oid );
        leafOids.add( TnShelfRiSerialNumber.oid );
            ...
            throws AdapterException
    {
        ...
        List<String> leafOids = new ArrayList<String>();
        leafOids.add( TnSlotProgrammedType.oid );
        leafOids.add( TnSlotPresentType.oid );
        //leafOids.add( TnSlotAdminState.oid );
        //leafOids.add( TnSlotOperationalState.oid );

        leafOids.add( TnCardName.oid );
        leafOids.add( TnCardSerialNumber.oid );
        leafOids.add( TnCardManufacturingPartNumber.oid );
        leafOids.add( TnCardSWPartNum.oid );
