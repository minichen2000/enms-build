...
public class ExecExternalScript
{
    ...
    public static Process run( ExternalScriptType scriptType, String... params )
            ...
            String... params ) throws AdapterException
    {
        ...
        switch( scriptType )
        {
             ...
             * q3EmlImScript; break; case KILL_EMLIM: fileDir = new File(
             * tstmgrDir ); cmdArray[0] = killEmlImScript; break;
             */
            default:
                break;
        }
    ...
    private static Process run4Stub( ExternalScriptType scriptType,
            String... params ) throws AdapterException
    {
        ...
        try
        {
            File stubPath = new File(
                    ConfLoader.getInstance().getConf( "EMLIM_STUB_PATH", "" ) );
    ...
    public static void main( String args[] )
    {
        ...
        String cmdArray[] = {"python", "emlim.py",
                "/opt/nms/EML_1/TSTMGR/scenario/CreateNe.req"};
        File stubPath = new File(
                "D:\\workspace6\\eNMS\\enms-test\\stub\\emlim.stub" );
        try
        {
