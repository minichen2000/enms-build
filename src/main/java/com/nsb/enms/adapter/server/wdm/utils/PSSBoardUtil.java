...
public class PSSBoardUtil {
	...
	private static Logger log = LogManager.getLogger(PSSBoardUtil.class);
	...
	// added by lihongji
	private static final HashMap<String, String> ECPortMap = new HashMap();
	...
	public static String getPSSPortDesc(String boardType, int port) {
		...
		/* 3912 */ if (boardType.equalsIgnoreCase("11DPM4M")) {
			/* 3913 */
			/* 3914 */ if ((port > 6) && (port < 11))/* 3915 */ boardType = "11DPM4E";
			/*      */ }
	...
	/*      */ {
		...
		ECPortMap.put("3", "ES1");
		ECPortMap.put("4", "ES2");
		EqptToPortMapTable.put("EC", ECPortMap);

	}

	public static void main(String args[]) {
		System.out.println(getPSSPortDesc("EC", 1));
	}
