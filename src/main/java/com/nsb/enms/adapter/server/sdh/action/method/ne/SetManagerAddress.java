...
public class SetManagerAddress {
	...
	private static String setMainOSAddressScenario = ConfLoader.getInstance().getConf(ConfigKey.SET_MAIN_OS_ADDR_REQ,
			ConfigKey.DEFAULT_SET_MAIN_OS_ADDR_REQ);

	private static String setSpareOSAddressScenario = ConfLoader.getInstance().getConf(ConfigKey.SET_SPARE_OS_ADDR_REQ,
