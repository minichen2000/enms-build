...
public class StartSupervision {
	private static final Logger log = LogManager.getLogger(StartSupervision.class);
	...
	public static boolean startSupervision(String groupId, String neId) throws AdapterException {
		...
		while (count < MAX_COUNT) {
			...
			try {
				Process process = ExecExternalScript.run(ExternalScriptType.TSTMGR, startSupervisionScenario, groupId,
						neId);
